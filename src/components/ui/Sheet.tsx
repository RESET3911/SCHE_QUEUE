...
export default function Sheet({ title, onClose, children }: Props) {
  return (
    <div className="fixed inset-0 z-50">
      ...
      <div className="animate-sheet-up absolute inset-x-0 bottom-0 mx-auto max-h-[85dvh] max-w-xl overflow-y-auto rounded-t-2xl border-x border-t border-board-line bg-board-panel">
